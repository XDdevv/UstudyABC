...
import com.uz.ustudy.ui.courses.model.Courses

class CoursesAdapter(private val courses: List<Courses>) : RecyclerView.Adapter<CoursesAdapter.CourseViewHolder>() {
